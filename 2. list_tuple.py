...
print("Element at row 2, column 3:", matrix_2d[1][2])

matrix_2d[1][2] = 10
print("Modified Matrix:", matrix_2d)
...
mixed_tuple_dict = {mixed_tuple: "Mixed Tuple Example"}

print("Tuple Dictionary:", mixed_tuple_dict)
...
print("Sorted Student Grades:", sorted_student_grades)
