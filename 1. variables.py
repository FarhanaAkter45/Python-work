...
# Creating a variable and assigning it a value of one type (string)
variable = "Hello"
print("Value of variable (initial):", variable)
print("Type of variable (initial):", type(variable))

# Reassigning the variable to a different type (integer)
variable = 123
print("Value of variable (updated):", variable)
print("Type of variable (updated):", type(variable))
