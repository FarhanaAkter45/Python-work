...
# Write a script that simulates a basic login system. Check username and password correctness.

username = input("Enter username: ")
password = input("Enter password: ")

# Hardcoded credentials (for demonstration purposes)
valid_username = "Farhana45"
valid_password = "password45"
...
weather = input("Enter weather conditions (sunny/snowy/other): ").lower()
